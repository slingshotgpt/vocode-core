...
from vocode.streaming.models.agent import SlingshotGPTAgentConfig
...
SlingshotGPTAgentConfigType = TypeVar("SlingshotGPTAgentConfigType", bound=SlingshotGPTAgentConfig)


def instantiate_openai_client(agent_config: SlingshotGPTAgentConfig, model_fallback: bool = False):
...
class SlingshotAgent(RespondAgent[SlingshotGPTAgentConfigType]):
    openai_client: Union[AsyncOpenAI, AsyncAzureOpenAI]

    def __init__(
        self,
        agent_config: SlingshotGPTAgentConfigType,
